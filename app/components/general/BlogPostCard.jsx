...
export default function BlogPostCard({ data }) {
    return (
        <div className="mt-6 group relative overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md transition-all hover:shadow-lg">
                ...
                <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <p className="text-sm font-medium text-gray-900">{data.authorName}</p>
                        </div>
